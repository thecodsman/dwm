...
static char selbordercolor[]        = "#ff751a";
static char selbgcolor[]            = "#ff751a";
...
static const char *defaulttagapps[] = { "st", "librewolf", "discord", "steam", NULL, "keepassxc", NULL, NULL, NULL };
...
static const Rule rules[] = {
	...
	*/
    ...
    { "steam",     "steamwebhelper",       NULL,       	    1 << 3,       1,           0,         0,        -1 },
    { "steam",     "steamwebhelper",       "Steam",       	    1 << 3,       0,           0,         0,        -1 },
    { NULL,     NULL,       "Roblox",       	    1 << 3,       0,           0,         0,        -1 },
...
static const Key keys[] = {
	...
	{ MODKEY|ControlMask,		XK_r,		spawn,		SHCMD("select_meme") },
	...
	{ MODKEY|ControlMask, 		XK_m, 		spawn, 		{.v = (const char*[]){ "music-search", NULL } } },
